...
# copied from training_loop and set up a vae-gan training
...
def training_loop(
    ...
    E_reg_interval          = 4,       # How often to perform regularization for E? None = disable lazy regularization.
    ...
    if (resume_pkl is not None) and (rank == 0):
        ...
        for name, module in [('E', E), ('G', G), ('D', D), ('G_ema', G_ema)]:
    ...
    phases = []
    for name, module, opt_kwargs, reg_interval in [('E', E, E_opt_kwargs, E_reg_interval),
